    ...
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center">
          {/* Simplified Profile Photo with elegant effect */}
          <div className="mb-8 relative inline-block">
            <div className="relative group"
              ...
              {/* Simple elegant border with single color */}
              <div className="w-40 h-40 md:w-52 md:h-52 rounded-full bg-indigo-500 p-1 shadow-xl group-hover:shadow-2xl transition-all duration-500 relative overflow-hidden">
                
                {/* Subtle rotating border effect */}
                <div className="absolute inset-0 rounded-full bg-gradient-to-r from-transparent via-white/20 to-transparent animate-spin group-hover:animate-ping transition-all duration-500" style={{ animationDuration: '3s' }}></div>
                
                {/* Photo container */}
                <div className="relative w-full h-full rounded-full bg-gray-200 dark:bg-gray-700 overflow-hidden group-hover:scale-105 transition-transform duration-500 z-10">
                  <img
                    src="/vaibhav.jpg"
                ...
                <div className="absolute -inset-8 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                  <div className="absolute top-0 left-1/4 w-1 h-1 bg-indigo-400 rounded-full animate-bounce" style={{ animationDelay: '0s' }}></div>
                  <div className="absolute top-1/4 right-0 w-0.5 h-0.5 bg-indigo-300 rounded-full animate-bounce" style={{ animationDelay: '0.5s' }}></div>
                  <div className="absolute bottom-1/4 left-0 w-1.5 h-1.5 bg-indigo-500 rounded-full animate-bounce" style={{ animationDelay: '1s' }}></div>
                  <div className="absolute bottom-0 right-1/4 w-0.5 h-0.5 bg-indigo-400 rounded-full animate-bounce" style={{ animationDelay: '1.5s' }}></div>
                </div>
              </div>
              
              {/* Simple glow effect */}
              <div className="absolute -inset-2 rounded-full bg-indigo-500/20 opacity-0 group-hover:opacity-60 blur-xl transition-all duration-500"></div>
            </div>
          </div>
