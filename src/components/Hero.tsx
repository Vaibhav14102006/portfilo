...
const Hero: React.FC = () => {
  ...
  // Modified parallax style with tap effect
  const parallaxStyle = {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        {/* Peacock Feather Inspired Background */}
        ...
        {/* Peacock Eye-like Floating Elements */}
        ...
        <div className="absolute bottom-20 right-20 w-96 h-96 bg-gradient-to-r from-teal-400/8 to-blue-400/8 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
        ...
        {/* Peacock Feather Glow Effect */}
        <div className="absolute inset-0 bg-gradient-to-tr from-transparent via-blue-500/[0.03] to-purple-500/[0.03]"></div>
      </div>

      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center">
          {/* Profile Photo with professional tap effect */}
